...
void analyse() {
    ...
    TH1I* particleType_h = (TH1I*)file->Get("particleType_h");
    ...
    TCanvas* myCanva = new TCanvas("myCanva", "Distributions");
    myCanva->Divide(2, 2);

    // PARTICLE TYPES: DRAWING
    myCanva->cd(1);
    ...
    TCanvas* myCanva2 = new TCanvas("myCanva2", "Invariant mass distributions");
    myCanva2->Divide(2, 2);
    ...
    TH1F* invMassSubtractionAll_h = new TH1F("invMassSubtractionAll_h", "Sub. All", 7000, 0., 5.);
    invMassSubtractionAll_h->Sumw2();
    invMassSubtractionAll_h->Add(invMassOppositeCharge_h, invMassSameCharge_h, 1, -1);
    TF1* invMassAllFit = new TF1("invMassAllFit", "[0] * TMath::Exp(-(x - [1]) * (x - [1]) / (2 * [2] * [2]))", 0.8, 1.);
    ...
    TH1F* invMassSubtractionPionKaon_h = new TH1F("invMassSubtractionPionKaon_h", "Sub. Pion-Kaon", 7000, 0., 5.);
    invMassSubtractionPionKaon_h->Sumw2();
    invMassSubtractionPionKaon_h->Add(invMassPionKaonOppositeCharge_h, invMassPionKaonSameCharge_h, 1, -1);
    TF1* invMassPionKaonFit = new TF1("invMassPionKaonFit", "[0] * TMath::Exp(-(x - [1]) * (x - [1]) / (2 * [2] * [2]))", 0.8, 1.);
